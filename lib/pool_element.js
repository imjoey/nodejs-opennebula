...
(function () {
  ...
  PoolElement.prototype.__chmod_ogo = function (id, method, owner_u, owner_m, owner_a,
    ...
    this.client.call(method, id, owner_u, owner_m, owner_a, group_u, group_m,
   ...
   * @return {[type]} [description]
   */
  PoolElement.prototype.chmod = function () {
    if (arguments.length === 12) {
      // call __chmod_ogo
      this.__chmod_ogo(arguments[0], arguments[1], arguments[2], arguments[3],
        arguments[4], arguments[5], arguments[6], arguments[7], arguments[8],
        arguments[9], arguments[10], arguments[11]);
    } else if (arguments.length === 4) {
      // call __chmod_octet
      this.__chmod_octet(arguments[0], arguments[1], arguments[2], arguments[3]);
    }
  };
