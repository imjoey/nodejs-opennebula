...
(function () {
  ...
  User.prototype.passwd = function (password, callback) {
    var params = [this.getId(), password];
   ...
   * @return {[type]}            [description]
   */
  User.prototype.chgrp = function (gid, callback) {
    var params = [this.getId(), gid];
   ...
   * @return {[type]}            [description]
   */
  User.prototype.chauth = function (auth, password, callback) {
    var params = [this.getId(), auth, password];
   ...
   * @return {[type]}                [description]
   */
  User.prototype.update = function (new_template, callback) {
    var params = [this.getId(), new_template];
   ...
   * @param {Function} callback       [description]
   */
  User.prototype.set_quota = function (quota_template, callback) {
    var params = [this.getId(), quota_template];
